'''
Biddle et al 2020 manuscript Figure 5:
Caption:
Model prediction summary for FLT during typical conditions with vegetation (solid) and without vegetation (dashed).
From top to bottom the parameters are; Q - River discharge (m3/s), SSCf - Depth averaged fine sediment concentration
(kg/m3), SSCc - Depth averaged coarse sediment concentration (kg/m3), |v ̅ | - Depth averaged current magnitude (m/s),
|τ_b | - Maximum wave and current bottom stress magnitude (N/m2) with a dotted line indicating the critical shear
stress of 0.049 N/m2.
