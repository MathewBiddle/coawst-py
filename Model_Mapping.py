...
for label in locs['Site']:
    if label in ['SUS','FLT']:#,'Tripod','SUS','FLT']:
        site=label
        ...
        if label == 'SUS':
            ...
            plt.scatter(x,y, s=50, marker='.', color='green',edgecolors='k', linewidths=0.3)
            plt.text(x + 500, y, label, fontdict=dict(size=5))
        elif label == 'Tripod':
...
outfile = '/Users/mbiddle/Documents/Personal_Documents/Graduate_School/Thesis/Paper/defense/SUS_FLT_map.png'
