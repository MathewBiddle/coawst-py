...
for event in times:
    ...
    for t in transect_data:
        ...
        for sed in sediment_type:
            ...
            print('%s %s %s integrated south flux = %g tons' % (event, t, sed,
    ...
    print('%s total sediment through T1: %e tons' % (event,T1_sand_integral+T1_mud_integral))
    print('%s total sediment through T2: %e tons\n' % (event, T2_sand_integral+T2_mud_integral))
